...
mcts.so: player_ext.o async_mcts.o board.o position_set.o graph.o tree.o array_list.o util.o
mcts1.so: player_ext.o async_mcts.o board.o position_set.o graph.o tree.o array_list.o util.o

alphabeta.so: player_ext.o alphabeta.o board.o position_set.o graph.o
alphabeta1.so: player_ext.o alphabeta.o board.o position_set.o graph.o

random.so: player_ext.o player.o board.o position_set.o graph.o
random1.so: player_ext.o player.o board.o position_set.o graph.o
